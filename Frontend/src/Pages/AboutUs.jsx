      ...
      <div className="about-content">
        ...
        <div className="about-section">
          ...
          <div className="about-image">
            <img src="http://localhost:5000/images/cake.jpg" alt="Delicious cake" />
          </div>
        </div>

        <div className="about-section">
          <div className="about-image">
            <img src="http://localhost:5000/images/pastry.jpg" alt="Tasty pastries" />
          </div>
          <div className="about-text">
            <h2>Our Story</h2>
            <p>
        ...
        <div className="about-section">
          ...
          <div className="about-image-join">
            <img src="http://localhost:5000/images/joinus.jpg" alt="Join Us" />
          </div>
        </div>
      </div>
    </>
